  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card border-0 shadow rounded">
        <div class="card-body">
	  <div class="p-2 mb-2">
           <a href ="/pro/addpro/"> <button type="button" class="btn btn-primary" ><i class="fas fa-plus" style="color:#fff;"></i> Tambah </button></a>
	  </div>
...
<script type="text/javascript">
  ...
  function create() {
    $.get("{{ route('pro.addpro') }}",{},
  function(data,status){
      $("#exampleModalLabel").html('Add Projects');
      $("#page").html(data);
...
function showedit(id) {
  $.get("{{ url('/pro/showedit') }}/"+id,{},
    function(data,status){
      $("#exampleModalLabel").html('Edit Kelurahan');
      $("#page").html(data);
      $("#exampleModal").modal('show');
    });
 }
