...
<script type="text/javascript">
  ...
  function create() {
    $.get("{{ route('mobil.addmobil') }}",{},
  function(data,status){
      $("#exampleModalLabel").html('Add Mobil');
      $("#page").html(data);
