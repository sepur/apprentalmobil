...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
	<h1 class="m-0">Add  Peminjaman</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
	  <li class="breadcrumb-item"><a href="#">Home</a></li>
	  <li class="breadcrumb-item active">Add Peminjaman</li>
	</ol>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  function create() {
    $.get("{{ route('peminjaman.addpeminjaman') }}",{},
  function(data,status){
      $("#exampleModalLabel").html('Add Peminjaman');
      $("#page").html(data);
...
function store() {
    ...
    $.ajax({
        url: "{{ url('peminjaman/savepeminjaman') }}",
        data: formData,
        cache: false,
        processData: false,
        contentType: false,
...
function showedit(id) {
  $.get("{{ url('peminjaman/showedit') }}/"+id,{},
    function(data,status){
...
function editstore(id) {
    ...
    $.ajax({
        url: "{{ url('peminjaman/editstore') }}/" + id,
        data: formData,
        cache: false,
        processData: false,
        contentType: false,
...
function pengembalian(id) {
    $.get("{{ url('pengembalian/addpengembalian') }}/" + id,{},
  function(data,status){
      $("#exampleModalLabel").html('Add pengembalian');
      $("#page").html(data);
      $("#exampleModal").modal('show');
    });
  }
...
function storepengambalian(id) {
    event.preventDefault();
    var form = $('#myform')[0];
    var formData = new FormData(form);
    
    console.log("ini datanya = ","ieee laiinnnnnnnnn");
    ...
    $.ajax({
        url: "{{ url('pengembalian/savepengembalian') }}/" + id,
        data: formData,
        cache: false,
        processData: false,
        contentType: false,
