   ...
   @csrf
      <div class="mb-4 row row-body">
         ...
         <div class="col-sm-9 col-md-9 col-lg-10 col-xl-10">
            <input type="text" oninput="this.value = this.value.toUpperCase()"  class="form-control" name="name"
               value="{{ old('name') }}" style="width: 300px;">
      ...
      <div class="mb-4 row row-body">
		...
		<select class="form-control" style="width: 300px;" name="departemen">
		  @foreach ($dep as $pt)
		    <option value="{{ $pt->id }}">{{ $pt->nama_departemen }}</option>
		  @endforeach
		</select>
        ...
        <div class="mb-4 row row-body">
         ...
         <div class="col-sm-9 col-md-9 col-lg-10 col-xl-10">
            <input type="password" class="form-control" name="password"
               value="{{ old('password') }}" style="width: 300px;">
