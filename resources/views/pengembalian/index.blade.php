...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
	<h1 class="m-0">Add  Pengembalian</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
	  <li class="breadcrumb-item"><a href="#">Home</a></li>
	  <li class="breadcrumb-item active">Add Pengembalian</li>
	</ol>
      </div>
    </div>
  </div>
...
function showedit(id) {
  $.get("{{ url('pengembalian/showedit') }}/"+id,{},
    function(data,status){
...
function editstore(id) {
    ...
    $.ajax({
        url: "{{ url('pengembalian/editstore') }}/" + id,
        data: formData,
        cache: false,
        processData: false,
        contentType: false,
...
function deletedata(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ url('pengembalian/destroy') }}/" + id,
