...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
	<h1 class="m-0">Add Jenis Mobil</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
	  <li class="breadcrumb-item"><a href="#">Home</a></li>
	  <li class="breadcrumb-item active">Add Jenis Mobil</li>
	</ol>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  function create() {
    $.get("{{ route('jenismobil.addjenismobil') }}",{},
  function(data,status){
      $("#exampleModalLabel").html('Add Jenis Mobil');
      $("#page").html(data);
...
function store() {
    ...
    $.ajax({
        url: "{{ url('jenismobil/savejenismobil') }}",
        data: formData,
        cache: false,
        processData: false,
        contentType: false,
...
function showedit(id) {
  $.get("{{ url('/jenismobil/showedit') }}/"+id,{},
    function(data,status){
      $("#exampleModalLabel").html('Edit Jenis Mobil');
      $("#page").html(data);
      $("#exampleModal").modal('show');
    });
 }
...
function editstore(id) {
    ...
    $.ajax({
        url: "{{ url('/jenismobil/editstore') }}/" + id,
        data: formData,
        cache: false,
        processData: false,
        contentType: false,
